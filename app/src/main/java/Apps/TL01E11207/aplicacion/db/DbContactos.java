package Apps.TL01E11207.aplicacion.db;
...
public class DbContactos extends DbHelper {
    ...
    public boolean editarContacto(int id, String nombre, String telefono, String pais) {
        ...
        try {
            db.execSQL("UPDATE " + TABLE_CONTACTOS + " SET nombre = '" + nombre + "', telefono = '" + telefono + "', pais = '" + pais + "' WHERE id='" + id + "' ");
            correcto = true;
        } catch (Exception ex) {
            ex.toString();
            correcto = false;
